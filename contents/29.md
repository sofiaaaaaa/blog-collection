...
by Krishelle Hardson-Hurley Apr 03, 2018
...
I believe that the first step in learning any programming language is making sure that you understand how to learn. Leanring how to learn is arguably the most critical skill involved in computer programming.
...
In this article, we will offer several learning strategies that will help jump start yourjourney of becoming a rockstar Python programmer!
...
As you progress on your journey as a new programmer, you may wonder if you should be taking notes. Yes, you should! In fact, research suggests that taking notes by hand is most benficial for long-term retention. This will be especially beneficial for those working towards the goal of becoming a full-time developer, as many interviews will involve writing code on a whiteboard.

Once you start working on small projects and programs, writing by hand can also help you plan your code before you move to the computer. You can save a lot of time if you wrtie out which functions and classes you will need, as well as how they will interact.
...
In programming, you code must follow the rules of a language and logic exactly, so even missing a quotation mark will break everything. Fresh eyes make a big difference.
...
When debugging, it is important to have a methodlogical approach to help you find where things are breaking down. Going through your code in the order in which it is executed and making sure each part works is a great way to do this.
...
Pair programming has many benefits: it gives you a chance to not only have someone review your code, but also see how someone else might be thinking about a problem. Being exposed to multiple ideas and ways of thinking will help you in problem soving when you got back to coding on your own. 
...
For beginners, there are many small exercises that will really help you become confident with Python, as well as develop the muscle memory that we spoke about above. Once you have a solid grasp on basic data structures (strins, lists, dictionaries, sets), object-oriented programming, and wrting classes, it's time to start building!

What you build is not as important as how you build it. The journey of building is truly what will teach you the most. You can only learn so much from reading Real Python articles and course. Most of your learning will come from using Python to build something. The problems you will solve will teach you a lot.
...
If you find it difficult to come up with Python partice projects to work on, watch this video. It lays out a strategy you can use to generate thousands of project ideas whenever you fell stuck. 

Tip #11: Contribute to Open Source
In the open-source model, software source code is available publicly, and anyone can collaborate. There are many Python libraries that are open-source projects and take contributions. Additionally, many comapnies publish opne-source projects. This means you can work with code written and produced by the engineers working in these companies.
...
For additional tips and tatics that will help you break into the open-source world, check out the video embedded below:
